-- Redefine booking_financials to remove legacy b.payment_amount references
-- Apply this AFTER backfill has been executed and verified
...
SELECT 
  ...
  COALESCE(p.payments_total,0)::numeric(12,2) AS payments_total,
  ...
  CASE 
    ...
    WHEN (COALESCE(p.payments_total,0)) > 0 THEN 'partial'
    ELSE 'unpaid'
